...
import { getUsers, getUser, putUser, deleteUser, recoveryPassword, resetPassword, uploadFile } from "../controllers/users.controller.js"
...
userRouter.post('/recovery-password', authorization(['user, admin']), recoveryPassword)
userRouter.post('/reset-password/:token', authorization(['user, admin']), resetPassword)
